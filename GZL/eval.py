...
class LogisticRegression_PyGCL(nn.Module):
    def __init__(self, num_features, num_classes):
        super(LogisticRegression_PyGCL, self).__init__()
...
class LREvaluator(BaseEvaluator):
    ...
    def evaluate(self, x: torch.FloatTensor, y: torch.LongTensor, split: dict):
        ...
        classifier = LogisticRegression_PyGCL(input_dim, num_classes).to(device)
